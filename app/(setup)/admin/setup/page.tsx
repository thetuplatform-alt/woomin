  ...
  return (
    <SetupClient
      ...
      detectedDefaults={{
        ...
        cloudflareAccountId: cloudflareStream.accountId,
        cloudflareApiToken: cloudflareStream.apiToken,
        cloudflareStreamCustomerCode: cloudflareStream.customerCode,
        cloudflareStreamSigningSecret: cloudflareStream.signingSecret,
        cloudflareStreamWebhookSecret: cloudflareStream.webhookSecret,
